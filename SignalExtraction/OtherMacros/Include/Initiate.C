...
list<TCut> DefineCuts(string period, bool excOnly) {
     ...
     */
    //V0cut[1] = "fV0CCounts < fNMatched + 3";
    V0cut[1] = "fNV0C < fNMatched + 3";
    //V0cut[1] = "";
    ...
    if (excOnly) {
        ...
        /*
         ...
         ZDCcutExc[1]= "!fZNCgoodTiming2 && !fZNAgoodTiming2";
         */
        ...
        TCut ADcutExc = "fADADecision != 1 && fADCDecision != 1";    // Pb does not dissociate
